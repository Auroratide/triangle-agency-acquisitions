> This prompt was used to generate boilerplate for a side-by-side markdown and page-rendering editor. Most of the code has since been replaced since the generated code was monolithic and not accessibly minded. It still provided value, better than starting from scratch. Sonnet 4.6 used.
